...
<body class="bd-body-7  bootstrap bd-pagebackground">
            ...
            <div class=" bd-horizontalmenu-1 clearfix">
                <div class="bd-container-inner">
                    ...
                    <ul class=" bd-menu-1 nav nav-pills navbar-left">
                            ...
                            <li class=" bd-menuitem-2 ">
                                <a 
 class="active" title="About" href="#" >Inicia sesión</a>
 ...
 data-page-id="page.12">
    ...
    <div class="bd-container-inner">
       <!-- <img class="bd-imagelink-20 bd-imagestyles   "  src="./assets/images/a47e2c1d2ba6caad39341939c0475a78_1460826112_group2.png">
