            ...
            <div class=" bd-horizontalmenu-1 clearfix">
                <div class="bd-container-inner">
                    ...
                    <ul class=" bd-menu-1 nav nav-pills navbar-left">
                            ...
                            <li class=" bd-menuitem-2 ">
                                <a 
 class="active" title="About" href="./about.html" >Registro</a>
   ...
   href="//twitter.com/share?url=&amp;text=">
    <span class="bd-icon"></span><span></span>
		   ...
		   <div class="contenedor-formulario">
                <div class="wrap">
                     <form class="formulario" action="php/guardar_cliente.php" name="formulario_registro" method="POST" enctype="multipart/form-data">
                    <div>
                     ...
                     <div class="input-group checkbox">
                        ...
                        <input type="submit" id="btn-submit" name="terminos" value="Enviar">
